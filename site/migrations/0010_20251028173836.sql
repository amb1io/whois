...
INSERT INTO "new_subscriptions" ("auth", "created_at", "domain_id", "endpoint", "id", "notify_changes", "notify_expiry", "p256dh", "updated_at", "user_id") SELECT "auth", "created_at", "domain_id", "endpoint", "id", "notify_changes", "notify_expiry", "p256dh", "updated_at", "user_id" FROM "subscriptions";
